...
public class SWTResourceManager {
    ...
    private static Map<Font, Font> m_fontToBiggerFontMap = new HashMap<Font, Font>();
    ...
    public static Font getBiggerFont(Font baseFont, int height) {
        Font font = m_fontToBiggerFontMap.get(baseFont);
        if (font == null) {
            FontData fontDatas[] = baseFont.getFontData();
            FontData data = fontDatas[0];
            font = new Font(Display.getCurrent(), data.getName(), height, data.getStyle());
            m_fontToBiggerFontMap.put(baseFont, font);
        }
        return font;
    }
    ...
    public static void disposeFonts() {
        ...
        // clear bigger fonts
        for (Font font : m_fontToBiggerFontMap.values()) {
            font.dispose();
        }
        m_fontToBiggerFontMap.clear();
    }

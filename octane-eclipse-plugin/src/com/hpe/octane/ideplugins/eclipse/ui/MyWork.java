...
public class MyWork extends ViewPart {
     ...
     */
    public static final String ID = "com.hpe.octane.ideplugins.eclipse.ui.MyWork";
    ...
    class ViewContentProvider implements ITreeContentProvider {
        ...
        private void initialize() {
            ...
            Collection<EntityModel> entityModelList = Activator.getServiceModuleInstance().getInstance(MyWorkService.class).getMyWork();
    ...
    private void hookContextMenu() {
        ...
        menuMgr.addMenuListener(new IMenuListener() {
            ...
            public void menuAboutToShow(IMenuManager manager) {
                MyWork.this.fillContextMenu(manager);
            }
        });

...
public class MultiSelectComboBox extends Composite {
    ...
    boolean floatingShellVisible = false;
    ...
    private void showFloatShell(Button display) {
        ...
        Shell shell = new Shell(MultiSelectComboBox.this.getShell(), SWT.BORDER);
        ...
        text.addModifyListener(new DelayedModifyListener(new ModifyListener() {
            ...
            public void modifyText(ModifyEvent e) {
                ...
                Rectangle shellRect = new Rectangle(p.x, p.y + size.y, scrolledComposite.computeSize(SWT.DEFAULT, SWT.DEFAULT).x + 10,
                        shellHeight + 10);

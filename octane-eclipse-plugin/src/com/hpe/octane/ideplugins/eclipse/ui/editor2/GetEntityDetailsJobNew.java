...
public class GetEntityDetailsJobNew extends Job {
    ...
    private Exception entityRetrieveFailedException;
    ...
    public GetEntityDetailsJobNew(String name, Entity entityType, long entityId) {
        super(name);
    ...
    protected IStatus run(IProgressMonitor monitor) {
        ...
        try {
        	...
        	entityRetrieveFailedException = ex;
        }
        monitor.done();
    ...
    public Exception wasEntityRetrived() {
        return entityRetrieveFailedException;
    }

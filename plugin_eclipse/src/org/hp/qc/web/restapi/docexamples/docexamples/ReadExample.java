...
public class ReadExample {
   ...
   public static void main(String[] args) throws Exception {
    ...
    public void readExample(final String serverUrl, final String domain, final String project, String username, String password) throws Exception {
        ...
        //use the login example code to login for this test. go over this code to learn how to authenticate/login/logout
        AuthenticateLoginLogoutExample login = new AuthenticateLoginLogoutExample();
        
        //use the writing example to generate an entity so that we may read it. go over this code to learn how to create new entities.
        ...
        //after accessing a resource, a qc session is implicitly created. the following code asserts this.
        Assert.assertTrue(
        ...
        Assert.assertEquals(
                "failed obtaining response for requirements collection " + requirementsUrl,
                HttpURLConnection.HTTP_OK,
                serverResponse.getStatusCode());
        ...
        //read the entity we generated in the above step. just perform a get operation on it's url.
        ...
        Assert.assertTrue("read element didn't contain field '"
                          ...
                          + "' with value '"
                          + Constants.entityToPostFieldValue
                          + "', though it's part of the posted element.", encounteredPostedField);

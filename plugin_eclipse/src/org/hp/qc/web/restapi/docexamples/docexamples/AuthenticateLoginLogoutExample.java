 ...
 * @author nathan
 * 
 * this example shows how to login/logout/authenticate to the server via rest. note that this is a
...
public class AuthenticateLoginLogoutExample {
    ...
    public void authenticateLoginLogoutExample(final String serverUrl, final String domain, final String project, String username, String password) throws Exception {
    ...
    public boolean login(String loginUrl, String username, String password) throws Exception {
        ...
        //create a string that lookes like "Basic ((username:password)<as bytes>)<64encoded>"
        ...
        Response response = con.httpPost(loginUrl, "", map);
    ...
    public String isAuthenticated() throws Exception {
        ...
        //not ok, not unauthorized - means some kind of error, maybe 404, or 500
        else {

 ...
 * @author nathan
 * 
 * this example shows multiple ways to create an entity, and also shows how to remove entities.
 * 
 */
public class CreateDeleteExample {
    ...
    public void createDeleteExample(final String serverUrl, final String domain, final String project, String username, String password) throws Exception {
        ...
        //use the login example to learn how to authenticate propertly. we use that functionality here to login so that we can do more complex actions.
        ...
        //build the location of the requirements collection, and the xml for an entity of type requirement
        ...
        the reason we build it with post and not createEntity, is that when posting the returned value is an xml representation */
        Map<String, String> requestHeaders = new HashMap<>();
        requestHeaders.put("Content-Type", "application/xml");
        requestHeaders.put("Accept", "application/xml");
        Response postedEntityResponse =
                con.httpPost(requirementsUrl, Constants.entityToPostXml.getBytes(), requestHeaders);
        ...
        Assert.assertEquals("posted entity does not equal deleted entity response", deletedEntityResponse, postedEntityResponseXml);
    ...
    public String deleteEntity(String entityUrl) throws Exception {
        ...
        //as we can see from the implementation below, to delete an entity is simply to use HTTP delete on it's url.
        Map<String, String> requestHeaders = new HashMap<>();
        requestHeaders.put("Accept", "application/xml");

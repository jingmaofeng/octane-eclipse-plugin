 ...
 * @author nathan
 * 
 * this class is meant mainly to keep the state of the connection for the examples. this class is a
 * singleton, and all examples get the instance in their default constructors - thus sharing state
 * (cookies, server url).
 * 
 * also some simple methods are implemented to get commonly used paths.
 * 
 */
public class RestConnector {
    
    public final static String TENANT_ID_QUERY_PARAM ="TENANTID=0"; 
    protected Map<String, String> cookies;
    /**
     * This is the url to the qc application.  It will be something like http://myhost:8080/qcbin .  Make sure that there is no
     * slash at the end
     */
    ...
    public String buildUrl(String path) {
        ...
        return String.format("%1$s/%2$s?%3$s", serverUrl, path,TENANT_ID_QUERY_PARAM) ;
    }
    ...
    public Response httpPost(String url, String data, Map<String, String> headers) throws Exception {

        return doHttp("POST", url, null, data.getBytes(), headers, cookies);
    }

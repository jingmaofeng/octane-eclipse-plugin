...
public class SystemTestConnect {
	...
	public void testConnectToServer() throws RestClientException {
		...
		Assert.assertEquals(restClient.getLastResponseCode(), HttpURLConnection.HTTP_OK);
		restClient.disconnect();
	}
	...
	public void checkAutoReconnect() throws RestClientException {
		...
		Assert.assertEquals(sizeEntities, sizeEntitiesRecconect);
	}
